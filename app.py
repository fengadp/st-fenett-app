...
st.markdown("ชำระเงินค่าลงทะเบียนผ่านเคาน์เตอร์ธนาคาร (Pay-In Slip) เท่านั้น เข้าบัญชีธนาคารไทยพาณิชย์ จำกัด (มหาชน) สาขากำแพงแสน (มหาวิทยาลัยเกษตรศาสตร์) ชื่อบัญชี :rainbow[มหาวิทยาลัยเกษตรศาสตร์ วิทยาเขตกำแพงแสน] เลขที่ :rainbow[769-200001-0]")
#st.markdown("ด้วยวิธี Pay-In Slip เพื่อใช้เป็นเอกสารประกอบการลงทะเบียน")
...
cols_2[1].markdown(":phone: 082-2376747 :email: fengwaso@ku.ac.th")
