...
cols_3[0].markdown("[![Charpa Tech](https://github.com/fengadp/st-fenett-app/blob/main/asset/S4.jpg?raw=true)](http://www.chareontut.com)")
#cols_3[1].image('./asset/S2.jpg')
cols_3[1].markdown("[![Charpa Tech](https://github.com/fengadp/st-fenett-app/blob/main/asset/S2.jpg?raw=true)](https://www.thaiunion.com/en)")
#cols_3[2].image('./asset/S5.png')
cols_3[2].markdown("[![Charpa Tech](https://github.com/fengadp/st-fenett-app/blob/main/asset/S5.png?raw=true)](http://www.thaiplc.com/)")

cols_4 = tabs[0].columns(3)
#cols_4[0].image('./asset/S1.png')
cols_4[0].markdown("[![Charpa Tech](https://github.com/fengadp/st-fenett-app/blob/main/asset/S1.png?raw=true)](https://charpa.co.th)")
#cols_4[1].image('./asset/S3.jpg')
cols_4[1].markdown("[![Charpa Tech](https://github.com/fengadp/st-fenett-app/blob/main/asset/S3.jpg?raw=true)](https://www.dutchmill.co.th)")
...
tabs[1].markdown(":dog: นักศึกษาเข้าร่วมประชุมหรือกิจกรรมแข่งขันนวัตกรรมวิศวกรรมอาหารเชิงสร้างสรรค์ 500 บาท")
