...
tabs[1].markdown(":red[หมายเหตุ] ค่าลงทะเบียนทั้งภาคบรรยายและโปสเตอร์จะคิดตามจำนวนเรื่องที่นำเสนอ กรณีส่งผลงานมากกว่าหนึ่งผลงานให้ลงทะเบียนแยกแต่ละผลงาน ถ้ามีผู้นำเสนอผลงานมากกว่า 1 คน คนที่เหลือจะต้องลงทะเบียนในฐานะผู้เข้าร่วมประชุม")
