...
#page_number = tabs[0].number_input(label='', min_value=1, label_visibility="collapsed", key='input_page_number')
with tabs[0].container(border=True):
...
#tabs[2].markdown("กำหนดส่งบทความฉบับเต็มภายใน :rainbow[วันที่ 7 กุมภาพันธ์ 2568]")
#tabs[2].markdown("การตอบรับบทความฉบับเต็มภายใน :rainbow[วันที่ 10 กุมภาพันธ์ 2568]")
tabs[2].markdown("กำหนดส่งบทคัดย่อ/บทความฉบับเต็มภายใน :rainbow[วันที่ 6 ธันวาคม 2567]")
tabs[2].markdown("การตอบรับบทความฉบับเต็มภายใน :rainbow[วันที่ 9 มกราคม 2568]")
