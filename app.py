...
st.image('./asset/QR_Form1.svg', width=200, caption="Scan เพื่อลงทะเบียน")
...
st.markdown(link, unsafe_allow_html=True)
st.image('./asset/QR_Form2.svg', width=200, caption="Scan เพื่อส่งบทความ")
...
cols_2[0].image('./asset/QR_Website.svg', width=200, caption="Website: https://fenett-2025.streamlit.app")
