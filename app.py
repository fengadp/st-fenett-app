...
st.markdown(":red[หมายเหตุ] กรณีส่งผลงานมากกว่าหนึ่งผลงานให้ลงทะเบียนแยกแต่ละผลงาน")
...
st.markdown("กำหนดส่งบทคัดย่อ/บทความฉบับเต็มภายใน :rainbow[วันที่ 6 ธันวาคม 2567]")
