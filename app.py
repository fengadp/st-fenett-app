...
cols_3[1].markdown("[![](https://github.com/fengadp/st-fenett-app/blob/main/asset/S3.jpg?raw=true)](https://www.dutchmill.co.th)")
...
cols_5[0].markdown("[![](https://github.com/fengadp/st-fenett-app/blob/main/asset/S10.jpg?raw=true)](https://www.sritranggroup.com/th/home)")
#cols_5[0].markdown("[![](https://github.com/fengadp/st-fenett-app/blob/main/asset/S6.png?raw=true)](http://www.upoic.co.th)")
...
cols_6[0].markdown("[![](https://github.com/fengadp/st-fenett-app/blob/main/asset/S6.png?raw=true)](http://www.upoic.co.th)")
...
tabs[1].markdown("ลงทะเบียนภายในวันที่ 31 มกราคม 2568 โดยมีอัตราค่าลงทะเบียนดังนี้")
tabs[1].markdown(":cat: ผู้นำเสนอภาคบรรยายระดับชาติ 2000 บาท")
tabs[1].markdown(":frog: นิสิต/นักศึกษา ผู้นำเสนอโครงงานระดับปริญญาตรีภาคบรรยายและนิทัศน์ (ท่านแรก ในกรณีที่มีผู้นำเสนอมากกว่า 1 ท่าน) 1000 บาท")
tabs[1].markdown(":tiger: อาจารย์และบุคคลทั่วไปเข้าร่วมประชุม 1000 บาท")
tabs[1].markdown(":dog: นิสิต/นักศึกษา ผู้นำเสนอโครงงานระดับปริญญาตรีภาคบรรยายและนิทัศน์ (ท่านที่ 2 เป็นต้นไป ในกรณีที่มีผู้นำเสนอมากกว่า 1 ท่าน), นิสิต/นักศึกษาเข้าร่วมประชุมหรือกิจกรรมแข่งขันนวัตกรรมวิศวกรรมอาหารเชิงสร้างสรรค์ 500 บาท")
tabs[1].markdown(":red[หมายเหตุ] ค่าลงทะเบียนทั้งภาคบรรยายและโปสเตอร์จะคิดตามจำนวนเรื่องที่นำเสนอ กรณีส่งผลงานมากกว่าหนึ่งผลงานให้ลงทะเบียนแยกแต่ละผลงาน ถ้ามีผู้นำเสนอผลงานมากกว่า 1 คน คนที่เหลือจะต้องลงทะเบียนในฐานะผู้เข้าร่วมประชุม ในกรณีที่ลงทะเบียนเข้าร่วมประชุมวิชาการแล้วและประสงค์จะเข้าร่วมกิจกรรมแข่งขันนวัตกรรมวิศวกรรมอาหารเชิงสร้างสรรค์ด้วยไม่จำเป็นต้องลงทะเบียนซ้ำในฐานะผู้เข้าร่วมกิจกรรมแข่งขันอีก")
...
link = '[Click เพื่อส่งบทคัดย่อ/บทความฉบับเต็ม กรุณาส่งทีละไฟล์](' + st.secrets.google.form2 + ')'
tabs[2].markdown(link, unsafe_allow_html=True)
tabs[2].image('./asset/QR_Form2.svg', width=150, caption="Scan เพื่อส่งบทความ")

tabs[2].subheader(':red[ส่งไฟล์นำเสนอภาคบรรยาย]')
link = '[Click เพื่อส่งไฟล์นำเสนอภาคบรรยาย กรุณาส่งทีละไฟล์](' + st.secrets.google.form4 + ')'
tabs[2].markdown(link, unsafe_allow_html=True)
tabs[2].image('./asset/QR_Form4.svg', width=150, caption="Scan เพื่อส่งบทความ")
