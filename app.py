...
st.markdown("ชำระเงินค่าลงทะเบียนด้วยวิธี Pay-In Slip เข้าบัญชีธนาคารไทยพาณิชย์ จำกัด (มหาชน) สาขากำแพงแสน (มหาวิทยาลัยเกษตรศาสตร์) ชื่อบัญชี :blue[มหาวิทยาลัยเกษตรศาสตร์ วิทยาเขตกำแพงแสน] เลขที่ :red[769-200001-0]")
